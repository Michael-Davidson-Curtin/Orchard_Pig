  ...
  <main class="container-fluid">
      ...
      <div class="container-fluid" id="drinks">
         ...
         <div class="container" >
             ...
             <div class="col-12 " id="info">
                     ...
                     <div class="info_panel">
                         <article id="main-info">
                             <h2>Bottled Brews....</h2>
                             <div id="main-text">
                             <p>Bursting with West Country bittersweet cider apples, expertly
                             crafted to our own special blend and slowly matured for a great taste
                             with real character. With more apples and less bubbles, our bottled ciders
                             are gently carbonated, leaving room for....<strong>more cider?</strong>
                             Gluten Free and suitable for Vegetarian, Vegans and Fruitarians</p>
                             </div>
             ...
             <div id="draughty_info">
             <div class="col-12 " id="info">
                     <div class="info_image"></div>
                     <div class="info_panel">
                         <article id="main-info">
                             <h2>Draughty Brews....</h2>
                             <div id="main-text">
                             <p>Bursting with West Country bittersweet cider apples, expertly
                             crafted to our own special blend and slowly matured for a great taste
                             with real character. With more apples and less bubbles, our bottled ciders
